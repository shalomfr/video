      ...
      <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-lg border border-border p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            התחבר כדי ליצור סרטונים מדהימים
          </p>
        </div>
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-2.5 rounded-xl border border-border hover:bg-muted transition-colors font-medium"
        >
